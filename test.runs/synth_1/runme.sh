...
HD_PWD='C:/Personal stuff/Year 2 Sem 2/CA/Projects/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mips_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_mips_new.tcl
