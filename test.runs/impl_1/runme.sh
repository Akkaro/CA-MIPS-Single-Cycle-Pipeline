...
HD_PWD='C:/Personal stuff/Year 2 Sem 2/CA/Projects/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mips_new.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_mips_new.tcl -notrace
